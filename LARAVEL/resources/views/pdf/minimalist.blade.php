...
<html>
<head>
    <title>Invoice - Minimalist Template</title>
    ...
    <style>
        ...
        body {
            background-image: url("{{ public_path('in_temp_bg/minimalist.webp') }}");
...
<body>
    ...
    <div class="container">
        ...
        <!-- Sender & Receiver Address (Fixed using Table Layout) -->
        ...
        <div class="payment-details">
            ...
            @if($bank_name || $account_num != null)
                <h2>Payment Details</h2>
                @if($bank_name)
                    <p>Bank Name: {{ $bank_name }}</p>
                @endif
                @if($account_num)
                    <p>Bank Name: {{ $account_num }}</p>
                @endif
            @endif
